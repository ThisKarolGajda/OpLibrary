package me.opkarol.oplibrary.event;
...
public class EventRegister {
    private static final Plugin opc = me.opkarol.oplibrary.Plugin.getInstance();
    ...
    public static boolean canRegister() {
        return Bukkit.getServer().getPluginManager().isPluginEnabled(opc);
    }
}
